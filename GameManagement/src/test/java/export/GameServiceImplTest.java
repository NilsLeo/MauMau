...
public class GameServiceImplTest {
    ...
    //     card2 = new Card(Suit.CLUBS, Value.SEVEN);
    //     card3 = new Card(Suit.CLUBS, Value.EIGHT);
    //     card4 = new Card(Suit.CLUBS, Value.NINE);
    //     card5 = new Card(Suit.CLUBS, Value.TEN);
    ...
    //     Player player = players.get(0);
    //     gameService.addCardToTable(card1);
    //     card2 = playerService.play(player, 0, gameService.getLeadSuit(), gameService.getLeadValue());
    ...
    //     gameService.addCardToTable(card1);
    //     Suit expectedSuit = card1.getSuit();
    //     // check if the lead card's suit is returned
    //     assertEquals(expectedSuit, gameService.getLeadSuit());
    // }
    // @Test
    // public void testGetLeadValue() {
    //     gameService.addCardToTable(card1);
    //     Value expectedValue = card1.getValue();
    //     // check if the lead card's value is returned
    //     assertEquals(expectedValue, gameService.getLeadValue());
    // }
